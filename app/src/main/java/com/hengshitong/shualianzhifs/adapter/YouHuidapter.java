...
public class YouHuidapter extends RecyclerView.Adapter<YouHuidapter.ItemHolder> {

    private static SharedPreferencesHelper sharedpa;
    List<YouHui> mStringList;
    private Context context;
    RelationOilgun sd;
    private Handler handleratwo;
    public YouHuidapter(Context context, Handler handleratwo ) {
        super();
    ...
    public ItemHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new  YouHuidapter.ItemHolder(view);
    }
...
//        sharedpa = new SharedPreferencesHelper(context, "anhua");
        ...
        try {
            List<RelationOilgun> list2 = SpUtils.getObject(context,
                    new TypeToken<List<RelationOilgun>>() { }.getType());
            if(list2.size()!=0){
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                EventBus.getDefault().post(new MessageEvent2(mStringList.get(position).getId(),position,"0"));
    ...
    public void addAll(List<YouHui> list) {
